...
| جزيرة الكنز | 1978 | HD | 26 | كلاسيكيات، أطفال، مغامرات |
...
- إعدادات فعلية للأقسام، ترتيب الحلقات، فحص الروابط، صور الحلقات، الجودة والتشغيل التلقائي.
- أقسام آخر الإضافات ومقترحات لك، مع شارة للمسلسلات الجديدة.
- دعم أسماء وصور مخصصة للحلقات، وجودات وسيرفرات احتياطية متعددة.
